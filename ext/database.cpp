...
//            std::shared_ptr<Tango::Database>(
        ...
        .def("get_device_alias", [](Tango::Database& self, const std::string& alias) -> std::string {
            std::string devname;
            self.get_device_alias(alias, devname);
            return devname;
        })
        .def("get_alias", [](Tango::Database& self, const std::string& devname) -> std::string {
            std::string alias;
...
//grm            convert2array(obj, par);
        ...
        .def("get_alias_from_device", [](Tango::Database& self, const std::string& input) -> std::string {
            std::string output;
            self.get_alias_from_device(input, output);
            return output;
        })
        .def("get_attribute_from_alias", [](Tango::Database& self, const std::string& input) -> std::string {
            std::string output;
            self.get_attribute_from_alias(input, output);
            return output;
        })
        .def("get_alias_from_attribute", [](Tango::Database& self, const std::string& input) -> std::string {
            std::string output;
