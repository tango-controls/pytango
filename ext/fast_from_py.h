...
template<long tangoArrayTypeConst>
inline typename TANGO_const2type(tangoArrayTypeConst)* fast_convert2array(py::object o)
{
    typedef typename TANGO_const2type(tangoArrayTypeConst) TangoArrayType;
    typedef typename TANGO_const2scalartype(tangoArrayTypeConst) TangoScalarType;
...
//    std::unique_ptr<Tango::DevVarLongArray> a_lng(
//        fast_convert2array<Tango::DEVVAR_LONGARRAY>(py_lng));
//
//    std::unique_ptr<Tango::DevVarStringArray> a_str(
//        fast_convert2array<Tango::DEVVAR_STRINGARRAY>(py_str));

    std::unique_ptr<TangoArrayType> result(new TangoArrayType());
...
//    std::unique_ptr<Tango::DevVarDoubleArray> a_dbl(
