...
{
public:
    PyCmd(std::string& name, Tango::CmdArgType in, Tango::CmdArgType out, std::string& in_desc,
            std::string& out_desc, Tango::DispLevel level) :
    ...
    PyCmd(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
