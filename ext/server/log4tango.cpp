...
// boost::noncopyable
    py::class_<log4tango::Level>(m, "Level")
        .def_static("get_name", &log4tango::Level::get_name,
            py::return_value_policy::copy)
        .def_static("get_value", &log4tango::Level::get_value)
    ;

    py::enum_<log4tango::Level::LevelLevel>(m, "LevelLevel")
...
//        .def(py::init<const std::string&, optional<log4tango::Level::Value> >())
...
// , boost::noncopyable
    py::class_<Tango::Logging, std::unique_ptr<Tango::Logging, py::nodelete>>(m, "Logging")
        .def_static("get_core_logger", &Tango::Logging::get_core_logger,
