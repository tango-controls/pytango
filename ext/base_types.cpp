...
inline bool operator==(const Tango::DbDevImportInfo& dii1, const Tango::DbDevImportInfo& dii2) {
    return dii1.name == dii2.name && dii1.exported == dii2.exported && dii1.ior == dii2.ior && dii1.version == dii2.version;
}
...
//    .def("raise_asynch_exception", &raise_asynch_exception);
    ...
    py::enum_<PyTango::ImageFormat>(m, "_ImageFormat")
...
//    //              >> exception (unexisting is stored in the other obj)
//
    py::class_<std::vector<std::string>>(m, "StdStringVector");

    py::class_<std::vector<long>>(m, "StdLongVector");

    py::class_<std::vector<double>>(m, "StdDoubleVector");

    py::class_<std::vector<Tango::CommandInfo>>(m, "CommandInfoList");

    py::class_<std::vector<Tango::AttributeInfo>>(m, "AttributeInfoList");

    py::class_<std::vector<Tango::AttributeInfoEx>>(m, "AttributeInfoListEx");

    py::class_<std::vector<Tango::PipeInfo>>(m, "PipeInfoList");

    py::class_<std::vector<Tango::Attr*>>(m, "AttrList");

    py::class_<std::vector<Tango::Attribute*>>(m, "AttributeList");

    py::class_<std::vector<Tango::Pipe*>>(m, "PipeList");
...
//    py::class_<std::vector<Tango::DbDatum>>(m, "DbData");
    ...
    py::class_<std::vector<Tango::DbDevExportInfos>>(m, "DbDevExportInfos");

    py::class_<std::vector<Tango::DbDevImportInfos>>(m, "DbDevImportInfos");

    py::class_<std::vector<Tango::DbHistory>>(m, "DbHistoryList");

    py::class_<std::vector<Tango::DeviceData>>(m, "DeviceDataList");

    py::class_<Tango::DeviceDataHistoryList>(m, "DeviceDataHistoryList");

    py::class_<std::vector<Tango::GroupReply>>(m, "StdGroupReplyVector");

    py::class_<std::vector<Tango::GroupCmdReply>>(m, "StdGroupCmdReplyVector");

    py::class_<std::vector<Tango::GroupAttrReply>>(m, "StdGroupAttrReplyVector");
//
